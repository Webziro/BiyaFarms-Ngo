      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        <ul class="navbar-nav w-100">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown1">
              <a class="dropdown-item active" href="blog.php">Blog posts</a>
    ...
    <div class="container pt-lg-4 pt-md-3">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <a href="blog-single.php">
                        <img class="card-img-bottom d-block radius-image-full" src="assets/images/blog1.jpg"
                            alt="Card image cap">
                    </a>
                </div>
                <div class="col-lg-6 blog-details align-self mt-lg-0 mt-4">
                    <a href="blog-single.php" class="blog-desc-big">Charity, Faith and hope, Help the poor, Help the Homeless
                    </a>
                    <div class="entry-meta mb-3"> 
                        <span class="comments-link"> <a href="blog-single.php#reply">Leave a Comment</a> </span> /
                    ...
                    <p>Lorem ipsum dolor sit amet elit. Eos, odit non ossimus voluptas sit nihil nam id
                        explicabo saepe sapiente, dicta officia odio natus nemo. Ratione
                        ipsa esse quod autem, in fugit odio.</p>
                    <a href="blog-single.php" class="btn btn-primary btn-style mt-4">Read More</a>
                </div>
            </div>
        </div>
        <div class="item mt-5">
            <div class="row">
                ...
                <div class="col-lg-6 blog-details align-self mt-lg-0 mt-4">
                    <a href="blog-single.php" class="blog-desc-big">NEW PRESS RELEASE – Request for an audience with First Lady Melania
                    </a>
                    <div class="entry-meta mb-3"> 
                        <span class="comments-link"> <a href="blog-single.php#reply">Leave a Comment</a> </span> /
                        <span class="cat-links"><a href="#url" rel="category tag">Uncategorized</a></span> / 
        ...
        <div class="item mt-5">
            <div class="row">
                ...
                <div class="col-lg-6 blog-details align-self mt-lg-0 mt-4">
                    <a href="blog-single.php" class="blog-desc-big">Children’s day celebration at Charity Foundation, USA.
                    </a>
                    <div class="entry-meta mb-3"> 
                        <span class="comments-link"> <a href="blog-single.php#reply">Leave a Comment</a> </span> /
                        <span class="cat-links"><a href="#url" rel="category tag">Uncategorized</a></span> / 
        ...
        <div class="item mt-5">
            <div class="row">
                <div class="col-lg-6">
                    <a href="blog-single.php">
                        <img class="card-img-bottom d-block radius-image-full" src="assets/images/blog4.jpg"
                            alt="Card image cap">
                    </a>
                </div>
                <div class="col-lg-6 blog-details align-self mt-lg-0 mt-4">
                    <a href="blog-single.php" class="blog-desc-big">School Uniform and Sweaters given to children of tribal school
                    </a>
                    <div class="entry-meta mb-3"> 
                        <span class="comments-link"> <a href="blog-single.php#reply">Leave a Comment</a> </span> /
                        <span class="cat-links"><a href="#url" rel="category tag">Uncategorized</a></span> / 
        ...
        <div class="item mt-5">
            <div class="row">
                <div class="col-lg-6">
                    <a href="blog-single.php">
                        <img class="card-img-bottom d-block radius-image-full" src="assets/images/blog5.jpg"
                            alt="Card image cap">
                    </a>
                </div>
                <div class="col-lg-6 blog-details align-self mt-lg-0 mt-4">
                    <a href="blog-single.php" class="blog-desc-big">Support and Donate to our charity when you shop on Amazon
                    </a>
                    <div class="entry-meta mb-3"> 
                        <span class="comments-link"> <a href="blog-single.php#reply">Leave a Comment</a> </span> /
                        <span class="cat-links"><a href="#url" rel="category tag">Uncategorized</a></span> / 
...
<!-- Mirrored from demo.w3layouts.com/demos_new/template_demo/01-09-2020/savepoor-liberty-demo_Free/1012221799/web/blog.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Jan 2023 21:25:42 GMT -->
</html>