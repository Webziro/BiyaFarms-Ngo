        ...
        <ul class="navbar-nav w-100">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown1">
              ...
              <a class="dropdown-item active" href="error.php">404 Error page</a>
...
<section id="error" class="w3l-error py-5 text-center">
    <div class="container py-lg-4 py-md-3">
        <div class="error-grid">
            ...
            <a href="index.php" class="btn btn-style btn-outline-primary mt-md-5 mt-4"> Back to home</a>
        </div>
    </div>
</section>
<!-- footer 14 -->
...
<!-- Mirrored from demo.w3layouts.com/demos_new/template_demo/01-09-2020/savepoor-liberty-demo_Free/1012221799/web/error.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Jan 2023 21:25:42 GMT -->
</html>