          ...
          <ul class="navbar-nav w-100">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown1">
                <a class="dropdown-item" href="#stats">Our Stats</a>
                <a class="dropdown-item" href="#videos">Some Videos</a>
                <a class="dropdown-item" href="#causes">Our Causes</a>
                <a class="dropdown-item" href="#mission">Mission & Goals</a>
                <a class="dropdown-item" href="#team">Volunteers</a>
                <a class="dropdown-item" href="#testimonials">Testimonials</a>
              </div>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#clients">Companies</a>
            </li>
            <li class="nav-item">
              ...
              <div class="search-right">
                ...
                <div id="search" class="pop-overlay">
                    <div class="popup">
                        ...
                        <form action="https://demo.w3layouts.com/demos_new/template_demo/01-09-2020/savepoor-liberty-demo_Free/1012221799/web/error.html" method="GET" class="search-box">
...
<div class="position-relative">
    <div class="shape overflow-hidden">
        <svg viewBox="0 0 2880 48" fill="none" xmlns="../../../../../../../www.w3.org/2000/svg.html">
          ...
          <div id="footers14-block">
              <div class="container">
                  ...
                  <div class="footers14-bottom d-flex">
                      <div class="copyright">
                          <p>© 2020 Save Poor. All rights reserved. Design by <a href="../../../../../../../w3layouts.com/index.html"
...
<!-- Mirrored from demo.w3layouts.com/demos_new/template_demo/01-09-2020/savepoor-liberty-demo_Free/1012221799/web/landing-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Jan 2023 21:25:42 GMT -->
</html>